...
const EditCategories = (props: Props) => {
    ...
    const editCategoriesHandler= async () =>{
        if(!areCategoriesUnchecked(data.layout.categories, categories) && !isAnyCategoryTitleEmpty(categories)){
            await editLayout ({
                type:"Categories",
                categories
            })
    ...
    isLoading ? (
        ...
        <div className='mt-[120px] text-center ' >
            ...
            <div className={`${styles.button} !w-[100px] !min-h-[40px] !h-[40px] dark:text-white text-black bg-[#cccccc34] 
                ${
                    areCategoriesUnchecked(data.layout.categories, categories) ||
