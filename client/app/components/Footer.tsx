  ...
  return (
    <footer>
      <div className="border border-[#00000e] dark:border-[#ffffff1e] ">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 ">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <Link href="https://github.com/rzkdwiputra" className="text-base text-black dark:text-gray-300 dark:hover:text-white">
                    Github
                  </Link>
                </li>
              </ul>
        ...
        <br />
        <p className="text-center text-black dark:text-white ">Copyright &copy; 2024 BrainNest | All Rights Reserved </p>
      </div>
    </footer>
  );
};
