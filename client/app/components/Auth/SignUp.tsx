...
const Signup: FC<Props> = ({setRoute}) => {
  ...
  return (
    <div className="w-full">
      <h1 className={`${styles.title}`}>Join to BrainNest</h1>
      <form onSubmit={handleSubmit}>
        <div className="mb-3  " >
        <label className={`${styles.label}`} htmlFor="email">
          Enter your name
        </label>
        <input type="text" name="" value={values.name} onChange={handleChange} id="name" placeholder="Your name" className={`${errors.name && touched.name && "border-red-500"} ${styles.input} `} />
